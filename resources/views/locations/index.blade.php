            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        @include('flash::message') <!--He indicado desde el controlador el flash, que se muestra aquí -->

                        <!-- Enviar al método del controlador create -->
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <!--En el método index del controlador tengo una variable locations,
                            array sobre el que itero, que tiene el contenido de los elementos-->
